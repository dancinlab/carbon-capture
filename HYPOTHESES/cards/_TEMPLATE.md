...
domain: sorbent | process | reactor | chip | plant | transmute | system
...
Tie to the architecture levels (L0 sorbent … L6 universal in `ARCHITECTURE.json`),
the imported spec (`state/n6-carbon-capture-spec.md`), and to sister hypotheses.
...
- **harness**: `tool/carbon_capture.py` (functions used)
